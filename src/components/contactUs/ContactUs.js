    ...
    <div className={styles.ContactUs}>
        ...
        <div className={styles.item} >
            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="80" height="80" viewBox="0,0,256,256"
                ...
                <a target='_blank' rel="noreferrer" href='https://wa.me/message/XNWS3MQLD2BTG1'>{text.wa}</a>
        <img src={wats} alt='whatsapp QR' />
        </div>

        <div className={styles.item} >
        <span style={{color:'var(--primary-color)' , fontSize:50 , marginBottom:20}} className="material-symbols-outlined">call</span>
        <p>01090486930</p>
        </div>
    </div>
</div>
